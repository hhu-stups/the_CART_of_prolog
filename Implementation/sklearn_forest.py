...
def train_test_classification(feature_train,target_train,feature_test,target_test,random_state):
...
def train_test_regression(feature_train,target_train,feature_test,target_test,random_state):
    t1 = time.process_time()
...
def run_iris():
    ...
    t1, p1 = train_test_classification(iris_feature_train1, iris_target_train1, iris_feature_test1, iris_target_test1, random_state=1)
    print('----------------------------------------------------------')
    print("Training iris: Set2")
    t2, p2 = train_test_classification(iris_feature_train2, iris_target_train2, iris_feature_test2, iris_target_test2, random_state=2)
    print('----------------------------------------------------------')
    print("Training iris: Set3")
    t3, p3 = train_test_classification(iris_feature_train3, iris_target_train3, iris_feature_test3, iris_target_test3, random_state=3)
    print('----------------------------------------------------------')
    print("Training iris: Set4")
    t4, p4 = train_test_classification(iris_feature_train4, iris_target_train4, iris_feature_test4, iris_target_test4, random_state=4)
    print('----------------------------------------------------------')
    print("Training iris: Set5")
    t5, p5 = train_test_classification(iris_feature_train5, iris_target_train5, iris_feature_test5, iris_target_test5, random_state=5)
    print('----------------------------------------------------------')
...
def run_digits():
    ...
    t1, p1 = train_test_classification(digits_feature_train1, digits_target_train1, digits_feature_test1, digits_target_test1, random_state=1)
    print('----------------------------------------------------------')
    print("Training digits: Set2")
    t2, p2 = train_test_classification(digits_feature_train2, digits_target_train2, digits_feature_test2, digits_target_test2, random_state=2)
    print('----------------------------------------------------------')
    print("Training digits: Set3")
    t3, p3 = train_test_classification(digits_feature_train3, digits_target_train3, digits_feature_test3, digits_target_test3, random_state=3)
    print('----------------------------------------------------------')
    print("Training digits: Set4")
    t4, p4 = train_test_classification(digits_feature_train4, digits_target_train4, digits_feature_test4, digits_target_test4, random_state=4)
    print('----------------------------------------------------------')
    print("Training digits: Set5")
    t5, p5 = train_test_classification(digits_feature_train5, digits_target_train5, digits_feature_test5, digits_target_test5, random_state=5)
    print('----------------------------------------------------------')
    mt = mean([t1,t2,t3,t4,t5])
    mp = mean([p1,p2,p3,p4,p5])
    var, abw, err = metrics([t1,t2,t3,t4,t5])
...
def run_diabetes():
    ...
    t1, p1, v1, a1, e1 = train_test_regression(diabetes_feature_train1, diabetes_target_train1, diabetes_feature_test1, diabetes_target_test1, random_state=1)
    print('----------------------------------------------------------')
    print("Training diabetes: Set2")
    t2, p2, v2, a2, e2 = train_test_regression(diabetes_feature_train2, diabetes_target_train2, diabetes_feature_test2, diabetes_target_test2, random_state=2)
    print('----------------------------------------------------------')
    print("Training diabetes: Set3")
    t3, p3, v3, a3, e3 = train_test_regression(diabetes_feature_train3, diabetes_target_train3, diabetes_feature_test3, diabetes_target_test3, random_state=3)
    print('----------------------------------------------------------')
    print("Training diabetes: Set4")
    t4, p4, v4, a4, e4 = train_test_regression(diabetes_feature_train4, diabetes_target_train4, diabetes_feature_test4, diabetes_target_test4, random_state=4)
    print('----------------------------------------------------------')
    print("Training diabetes: Set5")
    t5, p5, v5, a5, e5 = train_test_regression(diabetes_feature_train5, diabetes_target_train5, diabetes_feature_test5, diabetes_target_test5, random_state=5)
    print('----------------------------------------------------------')
    mt = mean([t1,t2,t3,t4,t5])
    mp = mean([p1,p2,p3,p4,p5])
...
def run_california():
    ...
    t1, p1, v1, a1, e1 = train_test_regression(california_feature_train1, california_target_train1, california_feature_test1, california_target_test1, random_state=1)
    print('----------------------------------------------------------')
    print("Training california: Set2")
    t2, p2, v2, a2, e2 = train_test_regression(california_feature_train2, california_target_train2, california_feature_test2, california_target_test2, random_state=2)
    print('----------------------------------------------------------')
    print("Training california: Set3")
    t3, p3, v3, a3, e3 = train_test_regression(california_feature_train3, california_target_train3, california_feature_test3, california_target_test3, random_state=3)
    print('----------------------------------------------------------')
    print("Training california: Set4")
    t4, p4, v4, a4, e4 = train_test_regression(california_feature_train4, california_target_train4, california_feature_test4, california_target_test4, random_state=4)
    print('----------------------------------------------------------')
    print("Training california: Set5")
    t5, p5, v5, a5, e5 = train_test_regression(california_feature_train5, california_target_train5, california_feature_test5, california_target_test5, random_state=5)
    print('----------------------------------------------------------')
    mt = mean([t1,t2,t3,t4,t5])
    mp = mean([p1,p2,p3,p4,p5])
    mv = mean([v1,v2,v3,v4,v5])
...
def run_all():
    sys.stdout = open("Iris_forest_Py.txt", "w")
    run_iris()
    sys.stdout.close()
    
    sys.stdout = open("Digits_forest_Py.txt", "w")
    run_digits()
    sys.stdout.close()
    
    sys.stdout = open("Diabetes_forest_Py.txt", "w")
    run_diabetes()
    sys.stdout.close()
    
    sys.stdout = open("California_forest_Py.txt", "w")
    run_california()
    sys.stdout.close()
