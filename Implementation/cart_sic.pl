:- module(cart_sic, [gini/2, count_class/3, part_class/3, zaehl/3, calc_class/3,
     split_class/4, combgini/3, impurity/3, best_split/3, get_max/3, get_classes/2, get_value/3,
     get_values_n/3, get_values_k/3,  my_powerset/3, combination/3, all_combinations/4,
     create_candidates/3, split_candidates_attribute/3, split_candidates/3,
