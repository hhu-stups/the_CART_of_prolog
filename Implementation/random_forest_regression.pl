:- module(random_forest_regression, [check_sample_forest/3,induce_forest/4,
    bootstrappen/3, choose_attributes/3, induce_trees/3, get_sample/3,check_forest/3,
    choose_all_members/4, check_all_sample_forest/3]).
